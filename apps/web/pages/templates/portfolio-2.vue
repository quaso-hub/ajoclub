...
<template>
  <div :style="styles" class="daida-page">
      ...
      <div class="daida-hero__content">
        ...
        <template v-else>
          ...
          <h1 :style="h1Style" class="daida-hero__title">
            Brand, web, dan<br>editorial<br>sejak 2014.
          </h1>
          <p class="daida-hero__sub">
            Studio desain di Bandung. Brand, web, dan editorial untuk museum, penerbit, dan brand komersial.
          </p>
    ...
    <TmplFooter data-reveal="fade-up" brand-name="Studio Daida"
      variant="columns"
      :links="[
        { label: 'Karya', href: '#karya' },
        { label: 'Layanan', href: '#layanan' },
